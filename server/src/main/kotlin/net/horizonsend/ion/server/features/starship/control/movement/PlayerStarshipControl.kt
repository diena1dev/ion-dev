...
object PlayerStarshipControl : IonServerComponent() {
	...
	fun onPlayerHoldItem(event: PlayerItemHeldEvent) {
		...
		val speed = (10.0f * baseSpeed * starship.directControlSpeedModifierFromIonTurrets * starship.directControlSpeedModifierFromHeavyLasers * (1000.0f / cooldown)).roundToInt() / 10.0f
